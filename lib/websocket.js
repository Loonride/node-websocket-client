...
// handshaking data.
var computeSecretKeySignature = function(s1, hs) { 
...
//      constructor.
var WebSocket = function(url, proto, opts, headers) {
        ...
        req.on('upgrade', (function() {
            ...
            return function(req, s, head) {
                ...
                stream.on('data', function(d) {
                    ...
                    if (data.length >= 16) {
                        var expected = computeSecretKeySignature(key1, challenge);
                        ...
                        //      that we added.
                        req.removeAllListeners('upgrade');
